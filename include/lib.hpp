...
// Note: This extern is based off the code from raylib
// You export functions like so:
//      EXPORT_LIB returnType MyFunction(arguments) { ... }
// The accompanying CMakeLists.txt file is REQUIRED for specifying some of the definitions used here.
// If not using CMake, consider implementing something similar.
